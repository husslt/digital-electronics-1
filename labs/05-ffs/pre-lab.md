...
-->
   ...
   **D-type FF**
   ...
   | ![rising](images/eq_uparrow.png) | 0 | 1 | 0 | `q(n+1)` is not dependent on the previous level `q` |
   | ![rising](images/eq_uparrow.png) | 1 | 0 | 1 | `q(n+1)` has the same level as `d` |
   | ![rising](images/eq_uparrow.png) | 1 | 1 | 1 | `q(n+1)` is not dependent on the previous level `q` |
